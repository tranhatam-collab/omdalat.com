...
- `app.omdalat.com` as the local operating layer
- optional internal admin and docs surfaces under the same product family
...
- `docs.omdalat.com` = public product and technical docs
