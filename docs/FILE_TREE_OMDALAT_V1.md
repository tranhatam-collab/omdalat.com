...
├── app/       # app.omdalat.com     (independent runtime, authenticated)
├── admin/     # admin.omdalat.com  (internal, noindex)
└── docs/      # docs.omdalat.com    (independent public documentation)
```
...
├── MASTER_BUILD_SYSTEM_OMDALAT.md
├── MASTER_BUILD_SYSTEM_OMDALA_OMDALAT.md ← legacy pointer only
