...
export async function generateMetadata(): Promise<Metadata> {
  return buildCurrentLocaleAppMetadata({
    title: {
      vi: "Vận hành sự kiện",
      en: "Events Operations"
    },
    description: {
      vi: "Lớp sự kiện nội bộ cho hoạt động sắp tới, liên kết host và địa điểm từ dữ liệu dùng chung.",
      en: "Internal events layer for upcoming activity, host links, and places from shared data."
    },
    path: "/events"
  });
}
