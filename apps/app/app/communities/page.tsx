...
export async function generateMetadata(): Promise<Metadata> {
  return buildCurrentLocaleAppMetadata({
    title: {
      vi: "Vận hành cộng đồng",
      en: "Communities Operations"
    },
    description: {
      vi: "Lớp cộng đồng nội bộ theo nhịp hoạt động và mật độ tín hiệu để điều phối node địa phương.",
      en: "Internal communities layer based on cadence and signal density for local node coordination."
    },
    path: "/communities"
  });
}
