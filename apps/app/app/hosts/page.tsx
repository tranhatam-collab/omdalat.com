...
export async function generateMetadata(): Promise<Metadata> {
  return buildCurrentLocaleAppMetadata({
    ...
    description: {
      vi: "Lớp host nội bộ theo trạng thái xác minh và mức khả dụng để hỗ trợ luồng trust.",
      en: "Internal host layer using verification and availability status to support trust flows."
    },
    path: "/hosts"
  });
}
