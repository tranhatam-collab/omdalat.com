...
export default async function CommunityDetailPage({ params }: { params: Promise<Params> }) {
  ...
  return (
    <DetailScaffold
      ...
      signals={[community.signal, { vi: "Trang này giúp bạn hiểu nhịp hoạt động và trọng tâm của cộng đồng.", en: "This page helps you understand the community's rhythm and focus." }]}
    />
  );
}
